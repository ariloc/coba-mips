...
\begin{figure}[H]
    ...
    \end{tabular}
    \caption{Diferencia entre el número original y el resultado obtenido usando \mintinline{sll}}
    \label{fig:bin-cmp-3-13}
\end{figure}

% TODO: Hablar de por qué no existe sla, usamos sll, ver operación lógica, no necesitamos la otra(?)
